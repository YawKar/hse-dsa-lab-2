...
BENCHMARK(BM_Building_NaiveRectangleEnumeration)->ArgName("Rectangles&Points")->DenseRange(10, 100, 10)->Iterations(100000);
BENCHMARK(BM_Building_NaiveRectangleEnumeration)->ArgName("Rectangles&Points")->DenseRange(200, 1000, 100)->Iterations(100000);
BENCHMARK(BM_Building_NaiveRectangleEnumeration)->ArgName("Rectangles&Points")->DenseRange(10000, 100000, 10000)->Iterations(10000);
...
BENCHMARK(BM_PerRequest_NaiveRectangleEnumeration)->ArgName("Rectangles&Points")->DenseRange(10, 100, 10)->Iterations(100000);
BENCHMARK(BM_PerRequest_NaiveRectangleEnumeration)->ArgName("Rectangles&Points")->DenseRange(200, 1000, 100)->Iterations(100000);
BENCHMARK(BM_PerRequest_NaiveRectangleEnumeration)->ArgName("Rectangles&Points")->DenseRange(10000, 100000, 10000)->Iterations(10000);
